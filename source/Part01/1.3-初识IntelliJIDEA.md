...
![创建新项目3](https://i.loli.net/2020/07/26/uEKceM4wsbtko9V.png)
...
<center><h4>恭喜你构建完成了，现在你可以在这里找到你构建的成品，把它拖动到 <code>1.13</code> 版本的 <code>Minecraft</code> 服务器插件文件夹内试试看？</h4></center>
